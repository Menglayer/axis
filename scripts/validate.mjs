...
const assertions = [
  ...
  [html.includes('styles.css?v=points-20260908'), "missing CSS cache-busting version"],
  [html.includes('app.js?v=points-20260908'), "missing app cache-busting version"],
  ...
  [app.includes("amount * pointsPerUsdPerDay * effectiveMultiplier"), "strategy Coordinates formula is missing"],
