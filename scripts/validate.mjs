...
const assertions = [
  ...
  [html.includes('styles.css?v=strategy-20260908'), "missing CSS cache-busting version"],
  [html.includes('app.js?v=strategy-20260908'), "missing app cache-busting version"],
