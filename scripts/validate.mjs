...
const assertions = [
  ...
  [html.includes('styles.css?v=tge-dec03-20260908'), "missing CSS cache-busting version"],
  [html.includes('app.js?v=tge-dec03-20260908'), "missing app cache-busting version"],
  ...
  [app.includes('tge: "2026-12-03"'), "TGE default is not 2026-12-03"],
